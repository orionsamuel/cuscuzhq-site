...
from inscricao.views import Cospobres, CospobreDetalhados, AlterarNotasCospobre, CospobreVencedores
from inscricao.views import Cosplays, CosplayDetalhados, AlterarNotasCosplay, CosplayVencedores
